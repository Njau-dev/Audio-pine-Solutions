<template>
    ...
    <div id="services" class="bg-bg relative w-full px-8 py-10 border-t border-border md:py-16 lg:py-24 xl:py-40 xl:px-0">
        <div class="container flex flex-col items-center justify-between h-full max-w-6xl mx-auto">
            ...
            <div class="flex flex-col w-full mt-0 lg:flex-row lg:flex-wrap sm:mt-10 lg:mt-20">
                ...
                <div class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <svg class="relative w-20 h-20" viewBox="0 0 24 24">
                            <defs>
                ...
                <div class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        <svg class="absolute w-full h-full text-lightshade fill-current" viewBox="0 0 358 372">
                            <path d="M315.7 6.5c30.2 15.1 42.6 61.8 41.5 102.5-1.1 40.6-15.7 75.2-24.3 114.8-8.7 39.7-11.3 84.3-34.3 107.2-23 22.9-66.3 23.9-114.5 30.7-48.2 6.7-101.3 19.1-123.2-4.1-21.8-23.2-12.5-82.1-21.6-130.2C30.2 179.3 2.6 141.9.7 102-1.3 62 22.4 19.7 58.1 6.3c35.7-13.5 83.3 2.1 131.2 1.7 47.9-.4 96.1-16.8 126.4-1.6z"/>
                        </svg>
                        <svg class="relative w-20 h-20" viewBox="0 0 24 24">
                            <defs>
